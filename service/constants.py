...
SB_MAX_SEARCH = 10
ESTABLISHMENT_DISTANCE_TOLERANCE = 1000  # 1km
ESTABLISHMENT_MAX_SEARCH = 10
STREET_AXIS_OFFSET = 10
...
DEPT_ID_LEN = 5
AGGLO_ID_LEN = 4
CENSUS_TRACT_ID_LEN = 7
CENSUS_BLOCK_ID_LEN = 9
LOCAL_GOVERNMENT_ID_LEN = 6
CENSUS_LOCALITY_ID_LEN = 8
SETTLEMENT_ID_LEN = (8, 10)
LOCALITY_ID_LEN = (8, 10)
STREET_ID_LEN = 15
STREET_BLOCK_ID_LEN = 22
EDUCATIONAL_INSTITUTIONS_ID_LEN = 9
UNIVERSITY_INSTITUTIONS_ID_LEN = 8
ESTABLISHMENT_ID_LEN = (8, 9)
