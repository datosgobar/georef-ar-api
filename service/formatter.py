...
_AGGLOMERATIONS_CSV_FIELDS = [
    (N.ID, [N.AGGLO, N.ID]),
    (N.NAME, [N.AGGLO, N.NAME]),
    (N.C_LAT, [N.AGGLO, N.CENTROID, N.LAT]),
    (N.C_LON, [N.AGGLO, N.CENTROID, N.LON]),
    (N.SOURCE, [N.AGGLO, N.SOURCE]),
]

_CENSUS_TRACTS_CSV_FIELDS = [
    (N.ID, [N.CENSUS_TRACT, N.ID]),
    (N.C_LAT, [N.CENSUS_TRACT, N.CENTROID, N.LAT]),
    (N.C_LON, [N.CENSUS_TRACT, N.CENTROID, N.LON]),
    (N.STATE_ID, [N.STATE, N.ID]),
    (N.STATE_NAME, [N.STATE, N.NAME]),
    (N.STATE_INTERSECTION, [N.STATE, N.INTERSECTION]),
    (N.SOURCE, [N.DEPT, N.SOURCE]),
...
_CENSUS_BLOCKS_CSV_FIELDS = [
    (N.ID, [N.CENSUS_BLOCK, N.ID]),
    (N.C_LAT, [N.CENSUS_BLOCK, N.CENTROID, N.LAT]),
    (N.C_LON, [N.CENSUS_BLOCK, N.CENTROID, N.LON]),
    (N.STATE_ID, [N.STATE, N.ID]),
    (N.STATE_NAME, [N.STATE, N.NAME]),
    (N.SOURCE, [N.DEPT, N.SOURCE]),
    (N.CATEGORY, [N.DEPT, N.CATEGORY])
...
_STREETS_CSV_FIELDS = [
    ...
    (N.CENSUS_LOCALITY_ID, [N.CENSUS_LOCALITY, N.ID]),
    (N.CENSUS_LOCALITY_NAME, [N.CENSUS_LOCALITY, N.NAME]),
    (N.LOCALITY_ID, [N.LOCALITY, N.ID]),
    (N.LOCALITY_NAME, [N.LOCALITY, N.NAME]),
...
_EDUCATIONAL_INSTITUTIONS_CSV_FIELDS = [
    (N.ID, [N.EDUCATIONAL_INSTITUTION, N.ID]),
    (N.NAME, [N.EDUCATIONAL_INSTITUTION, N.NAME]),
    (N.RAW_ADDRESS, [N.EDUCATIONAL_INSTITUTION, N.RAW_ADDRESS]),
    (N.C_LAT, [N.EDUCATIONAL_INSTITUTION, N.CENTROID, N.LAT]),
    (N.C_LON, [N.EDUCATIONAL_INSTITUTION, N.CENTROID, N.LON]),
    (N.STATE_ID, [N.STATE, N.ID]),
    (N.STATE_NAME, [N.STATE, N.NAME]),
    (N.DEPT_ID, [N.DEPT, N.ID]),
    (N.DEPT_NAME, [N.DEPT, N.NAME]),
    (N.SOURCE, [N.EDUCATIONAL_INSTITUTION, N.SOURCE]),
    (N.ADMINISTRATION, [N.EDUCATIONAL_INSTITUTION, N.ADMINISTRATION]),
    (N.CATEGORY, [N.EDUCATIONAL_INSTITUTION, N.CATEGORY])
]

_UNIVERSITY_INSTITUTIONS_CSV_FIELDS = [
    (N.ID, [N.UNIVERSITY_INSTITUTION, N.ID]),
    (N.NAME, [N.UNIVERSITY_INSTITUTION, N.NAME]),
    (N.RAW_ADDRESS, [N.UNIVERSITY_INSTITUTION, N.RAW_ADDRESS]),
    (N.C_LAT, [N.UNIVERSITY_INSTITUTION, N.CENTROID, N.LAT]),
    (N.C_LON, [N.UNIVERSITY_INSTITUTION, N.CENTROID, N.LON]),
    (N.STATE_ID, [N.STATE, N.ID]),
    (N.STATE_NAME, [N.STATE, N.NAME]),
    (N.DEPT_ID, [N.DEPT, N.ID]),
    (N.DEPT_NAME, [N.DEPT, N.NAME]),
    (N.SOURCE, [N.UNIVERSITY_INSTITUTION, N.SOURCE]),
    (N.ADMINISTRATION, [N.UNIVERSITY_INSTITUTION, N.ADMINISTRATION]),
    (N.CATEGORY, [N.UNIVERSITY_INSTITUTION, N.CATEGORY])
]

_NEARBY_ESTABLISHMENT_CSV_FIELDS = [
    (N.ID, [N.ESTABLISHMENT, N.ID]),
    (N.ESTABLISHMENT_TYPE, [N.ESTABLISHMENT, N.TYPE]),
    (N.C_LAT, [N.ESTABLISHMENT, N.CENTROID, N.LAT]),
    (N.C_LON, [N.ESTABLISHMENT, N.CENTROID, N.LON]),
    (N.NAME, [N.ESTABLISHMENT, N.NAME]),
    (N.RAW_ADDRESS, [N.ESTABLISHMENT, N.RAW_ADDRESS]),
    (N.DISTANCE, [N.ESTABLISHMENT, N.DISTANCE]),
    (N.SOURCE, [N.ESTABLISHMENT, N.SOURCE]),
]

_ENDPOINT_CSV_FIELDS = {
    N.STATES: _STATES_CSV_FIELDS,
    N.DEPARTMENTS: _DEPARTMENTS_CSV_FIELDS,
    N.AGGLOMERATIONS: _AGGLOMERATIONS_CSV_FIELDS,
    N.CENSUS_TRACTS: _CENSUS_TRACTS_CSV_FIELDS,
    N.CENSUS_BLOCKS: _CENSUS_BLOCKS_CSV_FIELDS,
    N.LOCAL_GOVERNMENTS: _LOCAL_GOVERNMENTS_CSV_FIELDS,
    N.MUNICIPALITIES: _LOCAL_GOVERNMENTS_CSV_FIELDS,
    ...
    N.EDUCATIONAL_INSTITUTIONS: _EDUCATIONAL_INSTITUTIONS_CSV_FIELDS,
    N.UNIVERSITY_INSTITUTIONS: _UNIVERSITY_INSTITUTIONS_CSV_FIELDS,
    N.NEARBY_ESTABLISHMENTS: _NEARBY_ESTABLISHMENT_CSV_FIELDS,
}
...
_SHP_SHORT_FIELD_NAMES = {
    ...
    for key, value in
    {
        ...
        N.SETTLEMENT_ID: "asent_id",
        N.SETTLEMENT_NAME: "asent_nom",
        N.ESTABLISHMENT_TYPE: "tipo_est"
    }.items()
}
