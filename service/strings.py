...
DEPENDENCY_ERROR = "El parámetro '{}' requiere que también se especifiquen los siguientes parámetros: {}."
...
ID_FIXED_LENGTH_PARAM_INVALID = 'Cada ID debe ser numérico y de longitud {}.'
ID_ALPHAMERIC_FIXED_LENGTH_PARAM_INVALID = 'Cada ID debe ser de longitud {}.'
